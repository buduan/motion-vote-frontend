      ...
      <div class="card card-border bg-base-100 mb-6">
        <div class="card-body">
          <div class="flex items-center justify-between mb-4">
            ...
            <button class="btn btn-outline btn-sm" @click="manageDebates">管理辩题</button>
          </div>
          <div v-if="activity.debates && activity.debates.length > 0" class="space-y-2">
            <div
              v-for="debate in activity.debates"
              :key="debate.id"
          ...
          <div v-else class="text-center py-8 text-base-content/60">暂无辩题</div>
        </div>
      </div>
      ...
      <div class="card card-border bg-base-100 mb-6">
        <div class="card-body">
          <div class="flex items-center justify-between mb-4">
            ...
            <button class="btn btn-outline btn-sm" @click="manageCollaborators">管理协作者</button>
          </div>
          <div v-if="activity.collaborators && activity.collaborators.length > 0" class="space-y-2">
            <div
              v-for="collaborator in activity.collaborators"
              :key="collaborator.id"
              class="flex items-center justify-between p-3 bg-base-200 rounded-lg"
            >
              <div class="flex items-center gap-3">
          ...
          <div v-else class="text-center py-8 text-base-content/60">暂无协作者</div>
        </div>
      </div>
      ...
      <div class="card card-border bg-base-100">
        <div class="card-body">
          <div class="flex items-center justify-between mb-4">
            ...
            <button class="btn btn-outline btn-sm" @click="manageParticipants">管理参与者</button>
          </div>
          ...
          <div v-else class="text-center py-8 text-base-content/60">暂无参与者</div>
        </div>
      </div>
    </div>
